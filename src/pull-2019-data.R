...
saveRDS(object = proj, file = 'projections/2019/2019-projections-parsed.rds')

nnul <- sapply(proj, function(x) !is.null(x[[2]]))

proj <- proj[nnul]
saveRDS(object = proj, file = 'projections/2019/2019-projections-parsed-clean.rds')



# add in holds from fangraphs

proj <- readRDS('projections/2019/2019-projections-parsed-clean.rds')
